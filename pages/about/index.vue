    ...
    <main class="main-mob">
      <div class="d-flex justify-content-between">
          <div class="side-bar">
            ...
            <NuxtLink to="/contact"><li data-aos="fade-right" data-aos-delay="700">{{ $t("Contact") }}</li></NuxtLink>
            </ul>
          </div>
          <div class="fin-bar">
            <nav data-aos="fade-left" data-aos-delay="300">
      ...
      <div class="center-section"> 
       <div class="content-section" data-aos="fade-down">
        ...
        <div class="side-bar" >
          <ul>
          <NuxtLink to="/about"><li data-aos="fade-right" data-aos-delay="300">{{ $t("About") }}</li></NuxtLink>
          </ul>
        </div>
        <div class="social">
         <div class="social">
